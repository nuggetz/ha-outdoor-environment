...
AQ_EXTRA_SENSORS: tuple[OutdoorSensorDescription, ...] = (
    OutdoorSensorDescription(key="formaldehyde", name="Formaldehyde", native_unit_of_measurement=UNIT_MICROGRAMS_PER_CUBIC_METER, state_class=SensorStateClass.MEASUREMENT, coordinator_type=_COORDINATOR_AQ, enabled_default=False),
    OutdoorSensorDescription(key="glyoxal", name="Glyoxal", native_unit_of_measurement=UNIT_MICROGRAMS_PER_CUBIC_METER, state_class=SensorStateClass.MEASUREMENT, coordinator_type=_COORDINATOR_AQ, enabled_default=False),
    OutdoorSensorDescription(key="nitrogen_monoxide", name="NO", native_unit_of_measurement=UNIT_MICROGRAMS_PER_CUBIC_METER, state_class=SensorStateClass.MEASUREMENT, coordinator_type=_COORDINATOR_AQ, enabled_default=False),
    OutdoorSensorDescription(key="peroxyacyl_nitrates", name="PAN", native_unit_of_measurement=UNIT_MICROGRAMS_PER_CUBIC_METER, state_class=SensorStateClass.MEASUREMENT, coordinator_type=_COORDINATOR_AQ, enabled_default=False),
    OutdoorSensorDescription(key="sea_salt_aerosol", name="Sea Salt Aerosol", native_unit_of_measurement=UNIT_MICROGRAMS_PER_CUBIC_METER, state_class=SensorStateClass.MEASUREMENT, coordinator_type=_COORDINATOR_AQ, enabled_default=False),
)
